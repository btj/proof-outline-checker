...
function updateListHeapObjectDOMNode(object) {
...
class AppendExpression extends Expression {
    target;
    item;
    constructor(loc, instrLoc, target, item) {
        super(loc, instrLoc);
        this.target = target;
        this.item = item;
    }
...
class ExtendExpression extends Expression {
    target;
    iterable;
    constructor(loc, instrLoc, target, iterable) {
        super(loc, instrLoc);
        this.target = target;
...
class InsertExpression extends Expression {
    ...
    index;
    item;
    constructor(loc, instrLoc, target, index, item) {
        super(loc, instrLoc);
        this.target = target;
        this.index = index;
        this.item = item;
...
class Type {
    containsInferredType(inferredType) {
        return false;
    }
    isListType() {
        return false;
...
class MayAliasRelation {
     ...
     */
    unionWithMayAliasRelation(other) {
     ...
     */
    getMayAliasesOfVariable(variable) {
...
function parseProofOutline(stmts, i, precededByAssert) {
    ...
    if (stmt instanceof AssertStatement) {
        ...
        const constType = args.reduceRight((acc, p) => TFun(parseType(p.type), acc), parseType(stmt.expr.target.type));
        let result = args.reduce((acc, arg) => App(stmt.expr.loc, acc, parseProofOutlineExpression(arg)), Const(stmt.expr.loc, mkConst("remove", constType)));
        ...
        const constType = args.reduceRight((acc, p) => TFun(parseType(p.type), acc), parseType(stmt.expr.lhs.target.type));
        let result = args.reduce((acc, arg) => App(stmt.expr.loc, acc, parseProofOutlineExpression(arg)), Const(stmt.expr.loc, mkConst("with_slice", constType)));
...
function collectVariablesInExpression(expr) {
...
function preconditionHasMayAlias(conditionAssertStatement, targetVariableName, mayAliasRelationOfStmt) {
...
function performMayAliasAnalysisOnBlock(blockStatement, preStateMayAliasRelation) {
 ...
 */
function performMayAliasAnalysis(stmts, i, preStateMayAliasRelation) {
    if (!(stmts.length == i)) {
        let stmt = stmts[i];
...
function checkProofOutline(checkEntailments, total, env, stmts, mayAliasesPreProofOutline) {
...
assert my_min(3, 2, 1) == 1`,
    ...
    return r
`,
        statements: `assert som(10, 20, 30) == 60`,
...
const aliasViolationExampleSameVariableAssignment = {
    declarations: `# Wet Uitgesteld: b
def method():
...
const aliasViolationExampleAppendMethod = {
    declarations: `# Wet Uitgesteld: b
def method():
...
const aliasViolationExampleClearMethod = {
    declarations: `# Wet Uitgesteld: b
def method(x):
    assert [1,2] == [1,2] #PRECONDITIE
    a = [1,2]
...
const aliasViolationExampleExtendMethod = {
    declarations: `# Wet Uitgesteld: b
def method(x):
    assert [1,2] == [1,2] #PRECONDITIE
    a = [1,2]
...
const aliasViolationExampleInsertMethod = {
    declarations: `# Wet Uitgesteld: b
def method(x):
    assert [1,2] == [1,2] #PRECONDITIE
    a = [1,2]
...
const aliasViolationExamplePopMethod = {
    declarations: `# Wet Uitgesteld: b
def method(x):
    assert [1,2] == [1,2] #PRECONDITIE
    a = [1,2]
...
const aliasViolationExampleRemoveMethod = {
    declarations: `def remove(L, E):
    if L[0] == E:
        return L[1:]
    else:
...
const aliasViolationExampleSliceAssignment = {
    declarations: `def max(x, y):
  if x < y:
    return y
  else:
...
const listMutationViolationExampleAppendTakesOnlyOneArgument = {
    declarations: `def method():
    r = [1,2]
    r.append(3,4)
    return r
...
const listMutationViolationExampleAppendTargetNotAList = {
    declarations: `def method():
    a = 1
    a.append(2)
    return a
...
const listMutationViolationExampleAppendTakesIntAsArgument = {
    declarations: `def method():
    a = [1,2,3,4]
    a.append(False)
    return a
...
const listMutationViolationExampleClearTargetNotAList = {
    declarations: `def method():
    a = True
    a.clear()
    return a
...
const listMutationViolationExampleClearTargetTakesNoArgument = {
    declarations: `def method():
    a = [1,2,3]
    a.clear(1)
    return a
...
const listMutationViolationExampleExtendTargetNotAList = {
    declarations: `def method():
    a = 0
    a.extend([1,2,3])
    return a
...
const listMutationViolationExampleExtendTargetTakesOneArgument = {
    declarations: `def method():
    a = [1,2,3]
    a.extend()
    return a
...
const listMutationViolationExampleExtendTakesListAsArgument = {
    declarations: `def method():
    a = [1,2,3]
    a.extend(4)
    return a
...
const listMutationViolationExampleExtendTakesListOfSameTypeElementsAsArgument = {
    declarations: `def method():
    a = [1,2,3]
    a.extend([True,1])
    return a
...
const listMutationViolationExampleInsertTargetNotAList = {
    declarations: `def method():
    a = False
    a.insert(0,1)
    return a
...
const listMutationViolationExampleInsertTargetTakesTwoArguments = {
    declarations: `def method():
    a = [1,2,3]
    a.insert(5)
    return a
...
const listMutationViolationExampleInsertTakesIntAsFirstArgument = {
    declarations: `def method():
    a = [1,2,3]
    a.insert(True,1)
    return a
...
const listMutationViolationExampleInsertTakesIntAsSecondArgument = {
    declarations: `def method():
    a = [1,2,3]
    a.insert(1,True)
    return a
...
const listMutationViolationExamplePopTargetNotAList = {
    declarations: `def method():
    a = 400
    a.pop()
    return a
...
const listMutationViolationExamplePopTakesOneOrZeroArguments = {
    declarations: `def method():
    a = [1,2,3]
    a.pop(1,0)
    return a
...
const listMutationViolationExamplePopTakesIntAsArgument = {
    declarations: `def method():
    a = [1,2,3]
    a.pop([5])
    return a
...
const listMutationViolationExampleRemoveTargetNotAList = {
    declarations: `def method():
    a = 400
    a.remove(0)
    return a
...
const listMutationViolationExampleRemoveTakesOnlyOneArgument = {
    declarations: `def method():
    a = [1,2,3]
    a.remove()
    return a
...
const listMutationViolationExampleRemoveTakesIntAsArgument = {
    declarations: `def method():
    a = [1,2,3]
    a.remove(True)
    return a
...
async function testAliasingViolationTestCase(testCase) {
...
async function testListMutationViolationTestCase(testCase) {
    const { declarations, errorMessage, locStart, locEnd } = testCase;
    let exceptionCaught = false;
    try {
        let decls = parseDeclarations(mkLocFactory(declarations), declarations, processComment);
...
async function runUnitTests() {
    ...
    function R(mayAliasSets) { return new MayAliasRelation(mayAliasSets); }
